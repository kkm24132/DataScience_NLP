...
Reading and handling Text from Images | <ul> <li>OpenCV</li> <li>PyTesseract</li> <li> [Here is an example to read text from images](https://towardsdatascience.com/read-text-from-image-with-one-line-of-python-code-c22ede074cac)</li> | Week 9-12 |
